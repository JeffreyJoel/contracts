    ...
    ERC20PaymentClientBase_v2
{
    ...
    /// @dev address of the funding pot admin.
    address internal fundingPotAdmin;
    ...
    /// @inheritdoc ILM_PC_FundingPot_v1
    function setFundingPotAdmin(address newAdmin_)
        external
