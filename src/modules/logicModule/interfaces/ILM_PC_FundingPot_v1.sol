...
interface ILM_PC_FundingPot_v1 is IERC20PaymentClientBase_v2 {
    ...
    error Module__LM_PC_FundingPot_InvalidFundingPotAdmin();
    ...
    /// @notice Returns the funding pot admin address.
    /// @return address_ The address of the funding pot admin.
    function getFundingPotAdmin() external view returns (address);
    ...
    /// @notice Set the funding pot admin address.
    /// @param  newAdmin_ The address of the new funding pot admin.
    function setFundingPotAdmin(address newAdmin_) external;

    /// @notice Revokes the funding pot admin role.
    function revokeFundingPotAdmin() external;
}
